...
import { cn } from "@/lib/utils"
import { PLAYERS } from "../constants/players"
import { assignRanks } from "@/utils/leaderboard"
import Waves from "@/Backgrounds/Waves/Waves"
...
export default function Leaderboard() {
  ...
  className="px-4 py-2 text-black bg-gray-300 rounded-lg transition-all duration-200 ease-in-out hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-opacity-50 shadow-sm hover:shadow-md"
>
  Show Top 3
</button>
            </div>
